...
const allCourses = [
  { name: "JavaScript Fundamentals", languages: ["JavaScript"] },
  { name: "Python for Beginners", languages: ["Python"] },
  { name: "Web Development with HTML/CSS", languages: ["HTML", "CSS"] },
  { name: "PHP", languages: ["test1", "test2"] },
