...
if(isset($_POST['submit'])){
   ...
   // Retrieve and sanitize the 'status' field from the form data
   $status = $_POST['status'];
   $status = filter_var($status, FILTER_SANITIZE_STRING);

   // Retrieve and sanitize the 'title' field from the form data
   $title = $_POST['title'];
   $title = filter_var($title, FILTER_SANITIZE_STRING);

   // Retrieve and sanitize the 'description' field from the form data
   $description = $_POST['description'];
   $description = filter_var($description, FILTER_SANITIZE_STRING);

   // Retrieve and sanitize the 'playlist' field from the form data
